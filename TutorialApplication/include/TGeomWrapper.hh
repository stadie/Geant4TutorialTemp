...
public:
  ...
  void Gspos(const char* name, Int_t nr, const char* mother,
	     ...
	     Int_t irot, const char* konly = "ONLY");
  ...
  Int_t Gsvolu(const char* name, const char* shape,
	       Int_t nmed, Float_t* upar, Int_t np);
  Int_t Gsvolu(const char* name, const char* shape, Int_t nmed,
	       Double_t* upar, Int_t np);

  void Material(Int_t& kmat, const char* name,
		Double_t a, Double_t z, Double_t dens, Double_t radl, 
  ...
  void Mixture(Int_t& kmat, const char* name,
	       Float_t* a, Float_t* z, Double_t dens, Int_t nlmat,Float_t* wmat);
  void Mixture(Int_t& kmat, const char* name,
	       Double_t* a,Double_t* z,Double_t dens,Int_t nlmat,Double_t* wmat);
