  ...
  , fScint(6)
{
  ...
  Material(fVacuum,"vacuum",1.0e-16,01.0e-16,01.0e-16,1.0e+16,0,junk,0);  
  ...
  Medium(fPb, "Pb",fPb,0,ifield,fieldm,tmaxfd,stemax,deemax,epsil, 
	 stmin,junk,0);
  Medium(fArGas,"Argon gas",fArGas,0,ifield,fieldm,tmaxfd,stemax,deemax,epsil, 
	 stmin,junk,0);
  Medium(fVacuum,"vacuum",fVacuum,0,ifield,fieldm,tmaxfd,stemax,deemax,epsil, 
	 stmin,junk,0);
  Medium(fFe,"Fe",fFe,0,ifield,fieldm,tmaxfd,stemax,deemax,epsil, 
	 stmin,junk,0);
  Medium(fU,"U",fU,0,ifield,fieldm,tmaxfd,stemax,deemax,epsil, 
	 stmin,junk,0);
  Medium(fScint,"scintillator",
	 fScint,0,ifield,fieldm,tmaxfd,stemax,deemax,epsil,stmin,junk,0);
}
...
//______________________________________________________________________________
void TGeomWrapper::Gsdvn(const char* name, const char* mother,
...
//______________________________________________________________________________
Int_t TGeomWrapper::Gsvolu(const char* name, const char* shape,
			   Int_t nmed, Float_t* upar, Int_t np)
{
...
//______________________________________________________________________________
Int_t TGeomWrapper::Gsvolu(const char* name, const char* shape,
			   Int_t nmed, Double_t* upar, Int_t np)
{
  fGeoMCGeometry->Gsvolu(name,shape,nmed,upar,np);
  if(first) {
    gGeoManager->SetTopVolume(gGeoManager->GetVolume(name));
...
//______________________________________________________________________________
void TGeomWrapper::Material(Int_t& kmat, const char* name,
			    Double_t a, Double_t z, Double_t dens,
			    Double_t radl, Double_t absl,
...
//______________________________________________________________________________
void TGeomWrapper::Matrix(Int_t& krot, Double_t thetaX,
			  Double_t phiX, Double_t thetaY, Double_t phiY, 
...
void TGeomWrapper::Medium(Int_t& kmed, const char* name, Int_t nmat,
			  ...
			  Double_t epsil, Double_t stmin, 
			  Float_t* ubuf, Int_t nbuf)
{
  fGeoMCGeometry->Medium(kmed,name,nmat,
			 isvol,ifield,fieldm,tmaxfd,stemax,deemax,epsil,
			 stmin,ubuf,nbuf);
  gMC->Medium(kmed,name,nmat,isvol,ifield,fieldm,tmaxfd,stemax,deemax,epsil,
	      stmin,ubuf,nbuf);
}
 

//______________________________________________________________________________
void TGeomWrapper::Medium(Int_t& kmed, const char* name,
			  Int_t nmat, Int_t isvol, Int_t ifield,
			  Double_t fieldm, Double_t tmaxfd, Double_t stemax,
			  Double_t deemax, Double_t epsil, Double_t stmin, 
			  Double_t* ubuf, Int_t nbuf)
{
  fGeoMCGeometry->Medium(kmed,name,nmat,isvol,
			 ifield,fieldm,tmaxfd,stemax,deemax,epsil,
			 stmin,ubuf,nbuf);
  gMC->Medium(kmed,name,nmat,isvol,ifield,fieldm,tmaxfd,stemax,deemax,epsil,
	      stmin,ubuf,nbuf);
}
...
//______________________________________________________________________________
void TGeomWrapper::Mixture(Int_t& kmat, const char* name,
			   Float_t* a, Float_t* z, Double_t dens, Int_t nlmat, 
			   Float_t* wmat)
{
...
//______________________________________________________________________________
Int_t TGeomWrapper::NofVolumes() const
{
  return gMC->NofVolumes();
}
...
//______________________________________________________________________________
Int_t TGeomWrapper::VolId2Mate(Int_t id) const
{
  return gMC->VolId2Mate(id);
} 

//______________________________________________________________________________
const char* TGeomWrapper::VolName(Int_t id) const
{
  return gMC->VolName(id);
}
